...
from code.Const import WIN_WIDTH, WIN_HEIGHT, COLOR_RED, MENU_OPTION, COLOR_WHITE, COLOR_GREEN
    ...
    def run(self, ):
        ...
        while True:
            ...
            for i in range(len(MENU_OPTION)):
                if i == menu_option:
                    self.menu_text(30,MENU_OPTION[i],COLOR_GREEN,(WIN_WIDTH/2, 200 + 25*i))
                else:
